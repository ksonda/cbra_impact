...
```
Here we provide a validation of the counts of bldgs by Microsoft vs Hand Counts by FWS in CBRA areas

```{r Validation}
attach(CBRA_lc_collapse)
summary(lm(CBRA_lc_collapse$bldg_counts_cbra_microsoft~CBRA_lc_collapse$bldg_counts_cbra_fws))

my.formula <- bldg_counts_cbra_micrososft ~ bldg_counts_cbra_fws
p <- ggplot(data = CBRA_lc_collapse, aes(bldg_counts_cbra_fws, bldg_counts_cbra_microsoft)) +
  geom_smooth(method = "lm", se=FALSE, color="black", formula = my.formula,data=CBRA_lc_collapse) +
  stat_poly_eq(formula = my.formula, 
               aes(label = paste(..eq.label.., ..rr.label.., sep = "~~~")), 
               parse = TRUE) +         
  geom_point() + geom_abline(intercept = 0.769, slope = 0.909)  + theme_bw(20) + xlab("Structure count by USFWS") + ylab("Structure count by Microsoft Bldg Footprints") + theme(aspect.ratio=1) + geom_text(x = 450, y = 2700, label = "y=0.77+0.91*x, R2=0.99")

png(paste0(Fig_dir,"Bldg_validation.png"),width=6,height=6,res=1200,units="in")
p
dev.off()
...
# p<-ggplot(CBRA_lc_collapse,aes(x=PropLandDeveloped*100, y=Structures_per_acre, color=Unit_Type)) + 
#   geom_point(aes(shape=Unit_Type, color=Unit_Type), size=6) +
#   theme_classic() + 
#   theme(legend.position="bottom") +
#   xlab("% Land Urbanized") +
#   ylab("Structures/Acre") +
#   theme(text = element_text(size=20), aspect.ratio=1) +
#   scale_color_grey() +
#   scale_shape_manual(values=c(19,17)) +
#   scale_y_continuous(breaks=seq(0,1.2,0.2)) +
#   geom_hline(yintercept=0.2) +
#   annotate(geom="text", x=75, y=0.225, label="0.2 Structures/Acre",size=5) +
#   theme(legend.title = element_blank())
# 
# p2<-ggMarginal(p,CBRA_lc_collpase,type="density",groupColour=TRUE,xparams=list(size=1.5),yparams=list(size=1.5))
# 
# 
# png(paste0(dir,"Analysis/CBRA_Impact_2016/Output/Figures/CRBA_Scatter.png"),width=10,height=10,res=1200,units="in")
# p2
# dev.off()
...
p1<-ggplot(plot_data[plot_data$State.x==st_list[1],], aes(Structures_per_hectare, County.x)) + theme_grey(base_size = 14) +  geom_vline(xintercept=0, size=1)+ 
  geom_line(aes(group = County.x, color=cluster),size=3) +
  geom_point(aes(color=cluster), size=7, shape=124) +
  theme_classic() +
  scale_colour_manual(name = "cluster",values = myColors) +
  theme(legend.position = "bottom") + theme(legend.background = element_rect(fill="white", size=0.5, linetype="solid"))  +
  ylab("Counties (ordered by Density in Non-System area)") + 
  theme(axis.title.x = element_text(hjust=0.0)) +
  theme(legend.title = element_blank()) +
   theme(legend.position = "none") +  scale_x_continuous(limit=c(-4.5,4.5),breaks=c(-4,-3,-2,-1,0,1,2,3,4),labels=c(4,3,2,1,0,1,2,3,4)) +
    #xlim(-4.5,4.5)+
  guides(color=guide_legend(ncol=2)) +  theme(axis.title.x=element_blank(),axis.title.y=element_blank()) + ggtitle("TX") + theme(plot.title = element_text(hjust = 0.5))  + colScale

p2<-ggplot(plot_data[plot_data$State.x==st_list[2],], aes(Structures_per_hectare, County.x)) + theme_grey(base_size = 14) +  geom_vline(xintercept=0, size=1)+ 
  geom_line(aes(group = County.x, color=cluster),size=3) +
  geom_point(aes(color=cluster), size=7, shape=124) +
  theme_classic() +
  scale_colour_manual(name = "cluster",values = myColors) +
  ...
  theme(legend.title = element_blank()) +
   theme(legend.position = "none") +  scale_x_continuous(limit=c(-4.5,4.5),breaks=c(-4,-3,-2,-1,0,1,2,3,4),labels=c(4,3,2,1,0,1,2,3,4)) +
    #xlim(-4.5,4.5)+
  guides(color=guide_legend(ncol=2)) +  theme(axis.title.x=element_blank(),axis.title.y=element_blank()) + ggtitle("LA") + theme(plot.title = element_text(hjust = 0.5))  + colScale

p3<-ggplot(plot_data[plot_data$State.x==st_list[3],], aes(Structures_per_hectare, County.x)) + theme_grey(base_size = 14) +  geom_vline(xintercept=0, size=1)+ 
  geom_line(aes(group = County.x, color=cluster),size=3) +
  geom_point(aes(color=cluster), size=7, shape=124) +
  theme_classic() +
  scale_colour_manual(name = "cluster",values = myColors) +
  ...
  theme(legend.title = element_blank()) +
   theme(legend.position = "none") +  scale_x_continuous(limit=c(-4.5,4.5),breaks=c(-4,-3,-2,-1,0,1,2,3,4),labels=c(4,3,2,1,0,1,2,3,4)) +
    #xlim(-4.5,4.5)+
  guides(color=guide_legend(ncol=2)) +  theme(axis.title.x=element_blank(),axis.title.y=element_blank()) + ggtitle("MS") + theme(plot.title = element_text(hjust = 0.5))  + colScale

p4<-ggplot(plot_data[plot_data$State.x==st_list[4],], aes(Structures_per_hectare, County.x)) + theme_grey(base_size = 14) +  geom_vline(xintercept=0, size=1)+ 
  geom_line(aes(group = County.x, color=cluster),size=3) +
  geom_point(aes(color=cluster), size=7, shape=124) +
  theme_classic() +
  scale_colour_manual(name = "cluster",values = myColors) +
  ...
  theme(legend.title = element_blank()) +
   theme(legend.position = "none") +  scale_x_continuous(limit=c(-4.5,4.5),breaks=c(-4,-3,-2,-1,0,1,2,3,4),labels=c(4,3,2,1,0,1,2,3,4)) +
    #xlim(-4.5,4.5)+
  guides(color=guide_legend(ncol=2)) +  theme(axis.title.x=element_blank(),axis.title.y=element_blank()) + ggtitle("AL") + theme(plot.title = element_text(hjust = 0.5))  + colScale


p5<-ggplot(plot_data[plot_data$State.x==st_list[5],], aes(Structures_per_hectare, County.x)) + theme_grey(base_size = 14) +  geom_vline(xintercept=0, size=1)+ 
  geom_line(aes(group = County.x, color=cluster),size=3) +
  geom_point(aes(color = cluster),size=7, shape=124) +
  theme_classic() +
  scale_color_grey() + 
  ...
  theme(legend.title = element_blank()) +
   theme(legend.position = "none") +  scale_x_continuous(limit=c(-4.5,4.5),breaks=c(-4,-3,-2,-1,0,1,2,3,4),labels=c(4,3,2,1,0,1,2,3,4)) +
    #xlim(-4.5,4.5)+
  guides(color=guide_legend(ncol=2)) +  theme(axis.title.x=element_blank(),axis.title.y=element_blank()) + ggtitle("FL") + theme(plot.title = element_text(hjust = 0.5))  + colScale

p6<-ggplot(plot_data[plot_data$State.x==st_list[6],], aes(Structures_per_hectare, County.x)) + theme_grey(base_size = 14) +  geom_vline(xintercept=0, size=1)+ 
  geom_line(aes(group = County.x, color=cluster),size=3) +
  geom_point(aes(color = cluster),size=7, shape=124) +
  theme_classic() +
  scale_color_grey() + 
  ...
  theme(legend.title = element_blank()) +
   theme(legend.position = "none") +  scale_x_continuous(limit=c(-4.5,4.5),breaks=c(-4,-3,-2,-1,0,1,2,3,4),labels=c(4,3,2,1,0,1,2,3,4)) +
    #xlim(-4.5,4.5)+
  guides(color=guide_legend(ncol=2)) +  theme(axis.title.x=element_blank(),axis.title.y=element_blank()) + ggtitle("GA") + theme(plot.title = element_text(hjust = 0.5))  + colScale

p7<-ggplot(plot_data[plot_data$State.x==st_list[7],], aes(Structures_per_hectare, County.x)) + theme_grey(base_size = 14) +  geom_vline(xintercept=0, size=1)+ 
  geom_line(aes(group = County.x, color=cluster),size=3) +
  geom_point(aes(color = cluster),size=7, shape=124) +
  theme_classic() +
  scale_color_grey() + 
  ...
  theme(legend.title = element_blank()) +
   theme(legend.position = "none") +  scale_x_continuous(limit=c(-4.5,4.5),breaks=c(-4,-3,-2,-1,0,1,2,3,4),labels=c(4,3,2,1,0,1,2,3,4)) +
    #xlim(-4.5,4.5)+
  guides(color=guide_legend(ncol=2)) +  theme(axis.title.x=element_blank(),axis.title.y=element_blank()) + ggtitle("SC") + theme(plot.title = element_text(hjust = 0.5))  + colScale

p8<-ggplot(plot_data[plot_data$State.x==st_list[8],], aes(Structures_per_hectare, County.x)) + theme_grey(base_size = 14) +  geom_vline(xintercept=0, size=1)+ 
  geom_line(aes(group = County.x, color=cluster),size=3) +
  geom_point(aes(color = cluster),size=7, shape=124) +
  theme_classic() +
  scale_color_grey() + 
  ...
  theme(legend.title = element_blank()) +
   theme(legend.position = "none") +  scale_x_continuous(limit=c(-4.5,4.5),breaks=c(-4,-3,-2,-1,0,1,2,3,4),labels=c(4,3,2,1,0,1,2,3,4)) +
    #xlim(-4.5,4.5)+
  guides(color=guide_legend(ncol=2)) +  theme(axis.title.x=element_blank(),axis.title.y=element_blank()) + ggtitle("NC") + theme(plot.title = element_text(hjust = 0.5))  + colScale



png(paste0(Fig_dir,"CountyClusterLinePlot_SU_vs_NonCoBRA_1.png"),width=15,height=22/4,res=1200,units="in")
multiplot(p1,p2,p3,p4,cols=4)

dev.off()


png(paste0(Fig_dir,"CountyClusterLinePlot_SU_vs_NonCoBRA_2.png"),width=15,height=22/4,res=1200,units="in")
multiplot(p5,p6,p7,p8,cols=4)

dev.off()

png(paste0(Fig_dir,"CountyClusterLinePlot_SU_vs_NonCoBRA_new.png"),width=15,height=22/4,res=1200,units="in")
multiplot(p1,p2,p3,p4,p5,p6,p7,p8,cols=8)
...
png(paste0(Fig_dir,"CountyClusterLinePlot_SU_vs_NonCoBRA_1.png"),width=11,height=11,res=1200,units="in")
p1 
...
yb<-d
yb<-yb%>%group_by(YearBuilt,cat,State)%>%summarize(Bldg_count=sum(NoOfBuildings,na.rm=TRUE),sqft=sum(sqfeet,na.rm=TRUE))
yb.area<-d%>%group_by(cat,State)%>%summarize(Area=sum(Area_clip))
yb<-left_join(yb,yb.area,by=c("cat","State"))

yb<-yb%>%group_by(cat,State)%>%mutate(cumulative_bldgs=cumsum(Bldg_count),cumulative_sqft=cumsum(sqft))
yb$bldg_ha<-yb$cumulative_bldgs/(yb$Area*0.404686)
yb$FAR<-yb$cumulative_sqft/(yb$Area*43560)
yb$Year<-yb$YearBuilt


yb<-filter(yb,!is.na(State))

pdf(file=paste0(Fig_dir,"timeseries_state_bldg_ha.pdf"),width=6.5,height=9)
  ggplot(yb,aes(x=Year,y=bldg_ha,col=cat)) + geom_line(lwd=1) + xlim(c(1950,2016)) +     scale_y_continuous(trans='log10',labels=comma) + facet_wrap(~ State, ncol=2) + theme_bw() + theme(legend.position="top") + ylab("log10 Buildings per Hectare")
dev.off()


pdf(file=paste0(Fig_dir,"timeseries_state_bldg_count.pdf"),width=6.5,height=9)
  ggplot(yb,aes(x=Year,y=cumulative_bldgs,col=cat)) + geom_line(lwd=1) + xlim(c(1950,2016)) +     scale_y_continuous(trans='log10',labels=comma) + facet_wrap(~ State, ncol=2) + theme_bw() + theme(legend.position="top") + ylab("log10 Building Count")
dev.off()

pdf(file=paste0(Fig_dir,"timeseries_state_FAR.pdf"),width=6.5,height=9)
  ggplot(yb,aes(x=Year,y=FAR,col=cat)) + geom_line(lwd=1) + xlim(c(1950,2016)) +     scale_y_continuous(trans='log10',labels=comma) + facet_wrap(~ State, ncol=2) + theme_bw() + theme(legend.position="top") + ylab("log10 FAR")
dev.off()

pdf(file=paste0(Fig_dir,"timeseries_state_sqft.pdf"),width=6.5,height=9)
  ggplot(yb,aes(x=Year,y=cumulative_sqft,col=cat)) + geom_line(lwd=1) + xlim(c(1950,2016)) +     scale_y_continuous(trans='log10',labels=comma) + facet_wrap(~ State, ncol=2) + theme_bw() + theme(legend.position="top") + ylab("log10 Total Sq ft")
dev.off()
```
...
# B.s<-p3%>%group_by(StructureDensity,cat,State)%>%summarise(Area_thousand=sum(Area_thousand))
# 
# 
# Bldg_Area_Cat_State<-ggplot() + 
#   geom_bar(aes(y = Area_thousand, x = cat, fill = StructureDensity), data = B.s, stat="identity") + coord_flip()  +
#   facet_grid(rows=vars(State),switch="y") +
#   theme_bw(base_size=20) + 
#   scale_fill_brewer(palette="Greys") +
#   ggtitle("Area of Parcels by CoBRA Category and Structure Density, by State")+
#   xlab("CoBRA Category") + ylab("Area (1000s Acres)") +
#   theme(legend.position="bottom")
# 
# 
# png(paste0(Fig_dir,"Bldg_Area_Cat_State.png"),width=16,height=9,res=1200,units='in')
# Bldg_Area_Cat_State
# dev.off()
# 
# Bldg_Area_Cat_State_percent<-ggplot() + 
#   geom_bar(aes(y = Area_thousand, x = cat, fill = StructureDensity), data = B.s, stat="identity", position="fill") + coord_flip()  +
#   theme_bw(base_size = 20) + 
#   facet_grid(rows=vars(State), switch="y") +
#   scale_fill_brewer(palette="Greys") +
#   ggtitle("Area (%) of Parcels by CoBRA Category and Structure Density, by State") +
...
# png(paste0(Fig_dir,"Bldg_Area_Cat_State_percent.png"),width=16,height=9,res=1200,units='in')
# Bldg_Area_Cat_State_percent
# dev.off()
...
Bldg_Area_Cat_LU_state<-ggplot(LU.st,aes(y=perc, x=LU, fill=LU)) + 
  geom_bar(stat="identity",position="dodge") + 
  coord_flip()  + 
  ggtitle("Area of Parcels by CoBRA Category and Structure Density") +
  theme_bw(base_size = 20) + 
  scale_fill_viridis_d() +
  ggtitle("(%) Area Land Use Categories (Zillow) by CoBRA Category  and State")+
  xlab("CoBRA Category") + ylab("(%) Area") +
  theme(legend.position="bottom") +
  facet_grid(rows=vars(State),cols=vars(cat),labeller = labeller(cat = label_wrap_gen(16)),switch="y")

png(paste0(Fig_dir,"Land_Use_Percent_State.png"),width=9,height=16,res=1200,units='in')
Bldg_Area_Cat_LU_state
dev.off()
...
# 
# 
# Overall<-ggplot() + geom_bar(aes(y = Area, x=State,fill=cat), data = p3,
#                            stat="identity") + scale_fill_brewer(palette="RdYlBu") + coord_flip() +
# theme_classic(base_size = 20) 
# 
# png(paste0(Fig_dir,"Overallclss.png"),width=16,height=9,res=1200,units='in')
# Overall
# dev.off()
# 
# Overall_percent<-ggplot() + geom_bar(aes(y = Area, x=State,fill=cat), data = p3, position="fill",
#                            stat="identity") + scale_fill_brewer(palette="RdYlBu") + coord_flip() + scale_y_continuous(labels = scales::percent)  +
# theme_classic(base_size = 20) 
# 
# png(paste0(Fig_dir,"Overallclss_percent.png"),width=16,height=9,res=1200,units='in')
# Overall_percent
# dev.off()
# 
# 
# 
# LU_all_percent<-ggplot() + geom_bar(aes(y = Area, x = cat, fill = LU_Class), data = p3, position="fill",
#                            stat="identity") + coord_flip()  +
# theme_classic(base_size = 20) 
# 
# png(paste0(Fig_dir,"LU_percent.png"),width=16,height=9,res=1200,units='in')
# LU_all_percent
# dev.off()
# 
# LU_all_percent_state<-ggplot() + geom_bar(aes(y = Area, x = cat, fill = LU_Class), data = p3, position="fill",
#                            stat="identity") + coord_flip()  +
# theme_classic(base_size = 20) + facet_grid(rows=vars(State))
# 
# png(paste0(Fig_dir,"LU_percent_state.png"),width=16,height=9,res=1200,units='in')
# LU_all_percent_state
# dev.off()
# 
# 
# LU_all<-ggplot() + geom_bar(aes(y = Area, x = cat, fill = LU_Class), data = p3,
#                            stat="identity") + coord_flip()  +
# theme_classic(base_size = 20) 
# 
# png(paste0(Fig_dir,"LU_all.png"),width=16,height=9,res=1200,units='in')
# LU_all
# dev.off()
# 
# #Undeveloped SubTable
# p3$X[which(p3$LU_Class=="No Data")]<-"No Data"
# p3$LU_Class[which(is.na(p3$LU_Class))]<-"No Data"
# p3$LU_Class[which(p3$LU_Class=="No Data")]<-"Unknown"
# p.NB<-p3[which(p3$StructureDensity!="Greater than 0.2 Structures/Acre"),]
# LU_NB<-ggplot() + geom_bar(aes(y = Area, x = cat, fill = LU_Class), data = p.NB,
#                            stat="identity", position="dodge") + coord_flip()  +
# theme_classic(base_size = 20) + scale_fill_brewer(palette="Dark2")
# 
# png(paste0(Fig_dir,"LU_NB.png"),width=16,height=9,res=1200,units='in')
# LU_all
# dev.off()
# 
# 
...
# 
# 
# #Residential SubTable
# p.res<-p3[which(p3$LU_Class=="Residential"),]
# 
# Res_Type<-ggplot() + geom_bar(aes(y = Area, x = cat, fill = LU_SubClass), data = p.res, position="fill",
#                            stat="identity") + coord_flip()  +
# theme_classic(base_size = 20) 
# 
# png(paste0(Fig_dir,"Res_Type.png"),width=16,height=9,res=1200,units='in')
# Res_Type
# dev.off()
# 
# Res_Type_sum<-ggplot() + geom_bar(aes(y = Area, x = cat, fill = LU_SubClass), data = p.res,
#                            stat="identity") + coord_flip()  +
# theme_classic(base_size = 20) 
# 
# png(paste0(Fig_dir,"Res_Type_sum.png"),width=16,height=9,res=1200,units='in')
# Res_Type_sum
# dev.off()
# 
# Res_Type_state<-ggplot() + geom_bar(aes(y = Area, x = cat, fill = LU_SubClass), data = p.res, position="fill",
#                            stat="identity") + coord_flip()  +
# theme_classic(base_size = 20) + facet_grid(rows=vars(State))
# 
# png(paste0(Fig_dir,"Res_Type_state.png"),width=16,height=9,res=1200,units='in')
# Res_Type_state
# dev.off()
# 
# 
# Res_Type_state_sum<-ggplot() + geom_bar(aes(y = Area, x = cat, fill = LU_SubClass), data = p.res,
#                            stat="identity") + coord_flip()  +
# theme_classic(base_size = 20) + facet_grid(rows=vars(State))
# 
# png(paste0(Fig_dir,"Res_Type_state_sum.png"),width=16,height=9,res=1200,units='in')
# Res_Type_state_sum
# dev.off()
# 
# 
# #Undeveloped SubTable
# 
# p.und<-p3[which(p3$LU_Class=="Undeveloped"),]
# 
# Und_Type<-ggplot() + geom_bar(aes(y = Area, x = cat, fill = LU_SubClass), data = p.und, position="fill",
#                            stat="identity") + coord_flip()  +
# theme_classic(base_size = 20)
# 
# png(paste0(Fig_dir,"Und_Type.png"),width=16,height=9,res=1200,units='in')
# Und_Type
# dev.off()
# 
# Und_Type_state<-ggplot() + geom_bar(aes(y = Area, x = cat, fill = LU_SubClass), data = p.und, position="fill",
#                            stat="identity") + coord_flip()  +
# theme_classic(base_size = 20) + facet_grid(rows=vars(State))
# 
# png(paste0(Fig_dir,"Und_Type_state.png"),width=16,height=9,res=1200,units='in')
# Und_Type_state
# dev.off()
...
# 1.	REG with %Parcel area covered by structures (Microsoft buildings)
# 2.	REG with %Parcel area covered by structures  (subset just parcels with structures) (Microsoft buildings)
# 3.	Y=0/1 if residential, weighted by area of parcel
...
#Area
# p1<-ggplot(data=b)+
#   geom_density(data=subset(b,Protection == "Unprotected"), aes(x=Area_truncate,y= ..scaled..,fill=factor(Protection)),trim=TRUE) +
#   geom_density(data=subset(b,Protection == "Protected"), aes(x=Area_truncate,y=-..scaled..,fill=factor(Protection)),trim=TRUE) +
#   coord_flip() + 
#   xlab("Area (acres, censored at 5 ac)") + 
#   ylab("Smoothed, Scaled Density") + 
#   facet_grid(~CoBRA_Status) + 
#   xlim(0,5) + 
#   scale_fill_brewer(palette="Greys") + 
#   theme_bw(base_size=20) + 
#   theme(legend.position="top") + 
#   scale_color_brewer("") + 
#   ggtitle("Distribution of Parcel Size by CoBRA and other Protective status") 
# 
# 
# png(paste0(Fig_dir,"Parcel_Size.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
# beanplot(Area_Parcel ~ Protection*CoBRA_Status, data=b, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Parcel Size (Acres)-log scale", cex.main=4,cex.lab=2,cex.axis=1.8)
# legend("bottomright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# dev.off()
# 
# t<-pairwise.wilcox.test(b$Area_Parcel,b$cat,p.adjust.method="bonferroni")
# write.csv(t$p.value,paste0(Tab_dir,"wilcox_parcelSize.csv"))
# 
# 
# png(paste0(Fig_dir,"Parcel_Size_State.png"),width=9,height=16,res=1200,units='in')
# p1 + facet_grid(rows=vars(State), cols=vars(CoBRA_Status))
# dev.off()
# 
...
# 
# p2<-ggplot(data=b)+
#   geom_density(data=subset(b,Protection == "Unprotected"), aes(x=LandMarketValue_Acre,y= ..scaled..,fill=factor(Protection)),trim=TRUE) +
#   
#   geom_density(data=subset(b,Protection == "Protected"), aes(x=LandMarketValue_Acre,y=-..scaled..,fill=factor(Protection)),trim=TRUE) +
#   coord_flip() + 
#   xlab(" 1,000 USD/Acre), censored at 5,000") + 
#   ylab("Smoothed, Scaled Density") + 
#   facet_grid(~CoBRA_Status) + 
#  # xlim(0,2000000) + 
#   scale_fill_brewer(palette="Greys") + 
...
#   theme(legend.position="top") + 
#   scale_color_brewer("") + 
#   ggtitle("Distribution of Market Value/Acre by CoBRA and other Protective status")
# 
# png(paste0(Fig_dir,"LandMarket_Acre_all.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
# beanplot(LandMarketValue_Acre ~ Protection*CoBRA_Status, data=b, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Land Market Value (USD/Acre) - log scale ", cex.main=4,cex.lab=2,cex.axis=1.8,log="y")
# legend("bottomright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# dev.off()
# 
# t<-pairwise.wilcox.test(b$LandMarketValue_Acre,b$cat,p.adjust.method="bonferroni")
# write.csv(t$p.value,paste0(Tab_dir,"wilcox_LandMarketValue_Acre_all.csv"))
# 
# 
# png(paste0(Fig_dir,"LandMarket_Acre_all_State.png"),width=9,height=16,res=1200,units='in')
# p2 + facet_grid(rows=vars(State), cols=vars(CoBRA_Status))
# dev.off()
...
m1<-tidy(lm(PercentParcelBldg~cat,data=b))
m1.f<-tidy(lm(PercentParcelBldg~cat+factor(FIPS),data=b))
m2<-tidy(lm(PercentParcelBldg~cat,data=b[b$Area.bldg>0,]))
m2.f<-tidy(lm(PercentParcelBldg~cat+factor(FIPS),data=b[b$Area.bldg>0,]))

# 
# 
# p3<-ggplot(data=b)+
#   geom_density(data=subset(b,Protection == "Unprotected"), aes(x=PercentParcelBldg,y= ..scaled..,fill=factor(Protection)),trim=TRUE) +
#  # geom_density(data=b, aes(x=PercentParcelBldg,y=..density..,fill=factor(cat)),trim=FALSE) +
#   geom_density(data=subset(b,Protection == "Protected"), aes(x=PercentParcelBldg,y=-..scaled..,fill=factor(Protection)),trim=TRUE) +
#   coord_flip() + 
#   xlab("Land Market Value (1,000 USD)/Acre)") + 
#   ylab("Smoothed, Scaled Density") + 
#   facet_grid(~CoBRA_Status) + 
#  # xlim(0,2000000) + 
#   scale_fill_brewer(palette="Greys") + 
...
#   theme(legend.position="top") + 
#   scale_color_brewer("") + 
#   ggtitle("Distribution of % Parcel Area covered by Structures")
# 
# png(paste0(Fig_dir,"PercentParcelBldgCovered.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
#  beanplot(PercentParcelBldg ~ Protection*CoBRA_Status, data=b, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "% Parcel Area covered by Structures", cex.main=4,cex.lab=2,cex.axis=1.8, bw="nrd0")
# legend("bottomright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# dev.off()
# 
# t<-pairwise.wilcox.test(b$PercentParcelBldg,b$cat,p.adjust.method="bonferroni")
# write.csv(t$p.value,paste0(Tab_dir,"wilcox_PercentParcelBldg_all.csv"))
# 
# png(paste0(Fig_dir,"PercentParcelBldgCovered_State.png"),width=9,height=16,res=1200,units='in')
# p3+ facet_grid(rows=vars(State), cols=vars(CoBRA_Status))
# dev.off()
...
#m1<-lm(PercentParcelBldg~cat,data=b)
...
# p4<-ggplot(data=b)+
#   geom_density(data=subset(b,Protection == "Unprotected"), aes(x=YearBuiltCensored,y= ..scaled..,fill=factor(Protection)),trim=TRUE) +
#  # geom_density(data=b, aes(x=PercentParcelBldg,y=..density..,fill=factor(cat)),trim=FALSE) +
#   geom_density(data=subset(b,Protection == "Protected"), aes(x=YearBuiltCensored,y=-..scaled..,fill=factor(Protection)),trim=TRUE) +
#   coord_flip() + 
#   xlab("Year Built (Censored 1950)") + 
#   ylab("Smoothed, Scaled Density") + 
#   facet_grid(~CoBRA_Status) + 
#  # xlim(0,2000000) + 
#   scale_fill_brewer(palette="Greys") + 
...
#   geom_vline(xintercept=1982, size=2) +
#   annotate(geom="text",x=1984, y=0, angle=0, label="1983 - Coastal Barrier Resources Act") +
#   geom_vline(xintercept=1990, size=2) +
#   annotate(geom="text",x=1992, y=0, angle=0, label="1990 - Coastal Barrier Improvement Act")
# 
# png(paste0(Fig_dir,"YearBuilt.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
#  beanplot(YearBuilt ~ Protection*CoBRA_Status, data=b, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Year Built (censored 1950)", cex.main=4,cex.lab=2,cex.axis=1.8, bw="nrd0", ylim=c(1950,2020))
# legend("bottomright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# abline(h=1982, col="red")
# text(3.5,1983.5, "1982", pos=2)
# text(3.5,1991.5, "1990",pos=2)
# abline(h=1990, col= "red")
# dev.off()

# t<-pairwise.wilcox.test(b$YearBuilt,b$cat,p.adjust.method="bonferroni")
# write.csv(t$p.value,paste0(Tab_dir,"wilcox_YearBuilt_all.csv"))
# 
# 
# png(paste0(Fig_dir,"YearBuilt_State.png"),width=9,height=16,res=1200,units='in')
# p4 + facet_grid(rows=vars(State), cols=vars(CoBRA_Status))
# dev.off()
# 
...
m3<-tidy(lm(log(sqm)~cat,data=r))
m3.f<-tidy(lm(log(sqm)~cat+factor(FIPS),data=r))

m4<-tidy(lm(FPR~cat,data=r))
m4.f<-tidy(lm(FPR~cat+factor(FIPS),data=r))

# p5<-ggplot(data=r)+
#   geom_density(data=subset(r,Protection == "Unprotected"), aes(x=FPR,y= ..scaled..,fill=factor(Protection)),trim=TRUE) +
#  # geom_density(data=b, aes(x=PercentParcelBldg,y=..density..,fill=factor(cat)),trim=FALSE) +
#   geom_density(data=subset(r,Protection == "Protected"), aes(x=FPR,y=-..scaled..,fill=factor(Protection)),trim=TRUE) +
#   coord_flip() + 
#   xlab("Footprint Building/Parcel Area (%)") + 
#   ylab("Smoothed, Scaled Density") + 
#   facet_grid(~CoBRA_Status) + 
#  # xlim(0,2000000) + 
#   scale_fill_brewer(palette="Greys") + 
...
#   theme(legend.position="top") + 
#   scale_color_brewer("") + 
#   ggtitle("% Residential Parcel Area covered by Building Footprint")
# 
# png(paste0(Fig_dir,"PercentParcelBldgCovered_Res.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
#  beanplot(FPR ~ Protection*CoBRA_Status, data=r, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = " % Residential Parcel Area covered by Structures", cex.main=4,cex.lab=2,cex.axis=1.8, bw="nrd0",log="")
# legend("topright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# dev.off()
# 
# t<-pairwise.wilcox.test(r$FPR,r$cat,p.adjust.method="bonferroni")
# write.csv(t$p.value,paste0(Tab_dir,"wilcox_FPR_res.csv"))
# 
# 
# png(paste0(Fig_dir,"PercentParcelBldgCovered_ResState.png"),width=9,height=16,res=1200,units='in')
# p5+ facet_grid(rows=vars(State), cols=vars(CoBRA_Status))
# dev.off()
...
# p6<-ggplot(data=s)+
#   geom_density(data=subset(s,Protection == "Unprotected"), aes(x=YearBuilt,y= ..scaled..,fill=factor(Protection)),trim=TRUE) +
#  # geom_density(data=b, aes(x=PercentParcelBldg,y=..density..,fill=factor(cat)),trim=FALSE) +
#   geom_density(data=subset(s,Protection == "Protected"), aes(x=YearBuilt,y=-..scaled..,fill=factor(Protection)),trim=TRUE) +
#   coord_flip() + 
#   xlab("Residence Age (Years, censored at 100)") + 
#   ylab("Smoothed, Scaled Density") + 
#   facet_grid(~CoBRA_Status) + 
#  # xlim(0,2000000) + 
#   scale_fill_brewer(palette="Greys") + 
...
#   theme(legend.position="top") + 
#   scale_color_brewer("") + 
#   ggtitle("Distribution of Residential Building Age")
# 
# png(paste0(Fig_dir,"Resi_Age.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
# beanplot(YearBuilt ~ Protection*CoBRA_Status, data=r, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Year Built (censored 1950)", cex.main=4,cex.lab=2,cex.axis=1.8,ylim=c(1950,2020))
# legend("bottomright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# abline(h=1982, col="red")
# text(3.5,1983.5, "1982", pos=2)
...
# dev.off()
# 
# t<-pairwise.wilcox.test(r$YearBuilt,r$cat,p.adjust.method="bonferroni")
# write.csv(t$p.value,paste0(Tab_dir,"wilcox_YearBuilt_res.csv"))
# 
# 
# 
# png(paste0(Fig_dir,"Resi_Age_State.png"),width=9,height=16,res=1200,units='in')
# p6 + facet_grid(rows=vars(State), cols=vars(CoBRA_Status))
# dev.off()

r$sqft<-r$sqfeet
#r$sqft[which(r$sqft>10000)]<-10000
r$sqft[which(r$sqft<500)]<-NA
#sqfeet
# p7<-ggplot(data=r)+
#   geom_density(data=subset(r,Protection == "Unprotected"), aes(x=sqft,y= ..scaled..,fill=factor(Protection)),trim=TRUE) +
#  # geom_density(data=b, aes(x=PercentParcelBldg,y=..density..,fill=factor(cat)),trim=FALSE) +
#   geom_density(data=subset(r,Protection == "Protected"), aes(x=sqft,y=-..scaled..,fill=factor(Protection)),trim=TRUE) +
#   coord_flip() + 
#   xlab("Residence Square Footage (censored at 10,000)") + 
#   ylab("Smoothed, Scaled Density") + 
#   facet_grid(~CoBRA_Status) + 
#  # xlim(0,2000000) + 
#   scale_fill_brewer(palette="Greys") + 
...
#   theme(legend.position="top") + 
#   scale_color_brewer("") + 
#   ggtitle("Distribution of Residential Square Footage")
# 
# png(paste0(Fig_dir,"Resi_sqft.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
#  beanplot(sqft ~ Protection*CoBRA_Status, data=r, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Residence Square Footage (censored at 10,000)", cex.main=4,cex.lab=2,cex.axis=1.8, ylim=c(0,10000), bw="nrd0", log="")
# legend("topright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# dev.off()
# 
# t<-pairwise.wilcox.test(r$sqft,r$cat,p.adjust.method="bonferroni")
# write.csv(t$p.value,paste0(Tab_dir,"wilcox_sqft_res.csv"))
# 
# 
# png(paste0(Fig_dir,"Resi_sqft_State.png"),width=9,height=16,res=1200,units='in')
# p7 + facet_grid(rows=vars(State), cols=vars(CoBRA_Status))
# dev.off()
...
#r$bed[which(r$TotalBedrooms>=10)]<-10


# p8<-ggplot(data=r)+
#   geom_bar(data=subset(r,Protection == "Unprotected"), aes(x=bed,y=..prop..,fill=factor(Protection)),colour="black") +
#  # geom_density(data=b, aes(x=PercentParcelBldg,y=..density..,fill=factor(cat)),trim=FALSE) +
#   geom_bar(data=subset(r,Protection == "Protected"), aes(x=bed,y=-..prop..,fill=factor(Protection)),colour="black") +
#   coord_flip() + 
#   xlab("# Bedrooms (censored at 10)") + 
#   ylab("Smoothed, Scaled Density") + 
#   facet_grid(~CoBRA_Status) + 
#    xlim(0,10) + 
#   scale_fill_brewer(palette="Greys") + 
#   theme_bw(base_size=20) + 
#   theme(legend.position="top") + 
#   ggtitle("Distribution of # Bedrooms") + scale_x_continuous(breaks=seq(1,10,1))
# 
# png(paste0(Fig_dir,"bedrooms.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
#  beanplot(bed ~ Protection*CoBRA_Status, data=r, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Bedrooms (censored at 10)", cex.main=4,cex.lab=2,cex.axis=1.8, bw="nrd0", log="",ylim=c(0,10))
# legend("bottomright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# dev.off()
# 
# t<-pairwise.wilcox.test(r$bed,r$cat,p.adjust.method="bonferroni")
# write.csv(t$p.value,paste0(Tab_dir,"wilcox_bedrooms_res.csv"))
# 
# 
# png(paste0(Fig_dir,"bedrooms_State.png"),width=9,height=16,res=1200,units='in')
# p8 + facet_grid(rows=vars(State), cols=vars(CoBRA_Status))
# dev.off()
# 
# 
# #bathrooms
# r$bath<-base::rowSums(cbind(r$FullBath,0.5*r$HalfBath,0.75*r$ThreeQuarterBath,0.25*r$QuarterBath),na.rm=T)
# r$bath[which(r$bath==0)]<-NA
# #r$bath[which(r$bath>6)]<-6
# 
# 
# p9<-ggplot(data=r)+
#   geom_bar(data=subset(r,Protection == "Unprotected"), aes(x=bath,y=..prop..,fill=factor(Protection)),colour="black") +
#  # geom_density(data=b, aes(x=PercentParcelBldg,y=..density..,fill=factor(cat)),trim=FALSE) +
#   geom_bar(data=subset(r,Protection == "Protected"), aes(x=bath,y=-..prop..,fill=factor(Protection)),colour="black") +
#   coord_flip() + 
#   xlab("# Bathrooms (censored at 6)") + 
#   ylab("Smoothed, Scaled Density") + 
#   facet_grid(~CoBRA_Status) + 
#    xlim(0,10) + 
#   scale_fill_brewer(palette="Greys") + 
#   theme_bw(base_size=20) + 
#   theme(legend.position="top") + 
#   ggtitle("Distribution of # Bathrooms") + scale_x_continuous(breaks=seq(0,10,0.5))
# 
# png(paste0(Fig_dir,"bathrooms.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
#  beanplot(bath ~ Protection*CoBRA_Status, data=r, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Bathrooms (censored at 6)", cex.main=4,cex.lab=2,cex.axis=1.8, bw="nrd0", log="", ylim=c(0,6))
# legend("bottomright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# dev.off()
# 
# t<-pairwise.wilcox.test(r$bath,r$cat,p.adjust.method="bonferroni")
# write.csv(t$p.value,paste0(Tab_dir,"wilcox_bathroom_res.csv"))
# 
# 
# png(paste0(Fig_dir,"bathrooms_State.png"),width=9,height=16,res=1200,units='in')
# p9 + facet_grid(rows=vars(State), cols=vars(CoBRA_Status))
# dev.off()
...
#r$Val_sqft[which(r$Val_sqft>500)]<-500

# p10<-ggplot(data=r)+
#   geom_density(data=subset(r,Protection == "Unprotected"), aes(x=Val_sqft,y= ..scaled..,fill=factor(Protection)),trim=TRUE) +
#  # geom_density(data=b, aes(x=PercentParcelBldg,y=..density..,fill=factor(cat)),trim=FALSE) +
#   geom_density(data=subset(r,Protection == "Protected"), aes(x=Val_sqft,y=-..scaled..,fill=factor(Protection)),trim=TRUE) +
#   coord_flip() + 
#   xlab("Value (USD/sqft, censored at 500 USD/sqft)") + 
#   ylab("Smoothed, Scaled Density") + 
#   facet_grid(~CoBRA_Status) + 
#  # xlim(0,2000000) + 
#   scale_fill_brewer(palette="Greys") + 
...
#   theme(legend.position="top") + 
#   scale_color_brewer("") + 
#   ggtitle("Distribution of Assessed Improvement Market Value (USD/sqft)")
# 
# png(paste0(Fig_dir,"Resi_val_sqft2.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
#  beanplot(Val_sqft ~ Protection*CoBRA_Status, data=r, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Improvement Market Value/ sqft", cex.main=4,cex.lab=2,cex.axis=1.8,ylim=c(10,1000))
# legend("bottomright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# dev.off()
# 
# t<-pairwise.wilcox.test(r$Val_sqft,r$cat,p.adjust.method="bonferroni")
# write.csv(t$p.value,paste0(Tab_dir,"wilcox_valsqft_res.csv"))
# 
# 
# png(paste0(Fig_dir,"Resi_val_sqft_State.png"),width=9,height=16,res=1200,units='in')
# p10 + facet_grid(rows=vars(State), cols=vars(CoBRA_Status))
# dev.off()
...
png(paste0(Fig_dir,"LandMarket_Acre_res.png"),width=16,height=9,res=1200,units='in')
par(mar=c(5,6,4,1)+.1)
beanplot(Land_Val_Acre ~ Protection*CoBRA_Status, data=r, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Land Market Value (USD/Acre) - log scale ", cex.main=4,cex.lab=2,cex.axis=1.8)
legend("bottomright", fill = c("black", "grey"), cex=1.8,
legend = c("Unprotected", "Protected"))
dev.off()

t<-pairwise.wilcox.test(r$Land_Val_Acre,r$cat,p.adjust.method="bonferroni")
write.csv(t$p.value,paste0(Tab_dir,"wilcox_landvalacre_res.csv"))



##Sale Price/ sqft
# 
# png(paste0(Fig_dir,"SalePrice_res.png"),width=16,height=9,res=1200,units='in')
# par(mar=c(5,6,4,1)+.1)
# beanplot(RealSalesPrice2016 ~ Protection*CoBRA_Status, data=s, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Sale Price (2016 USD) - log scale ", cex.main=4,cex.lab=2,cex.axis=1.8,ylim=c(10000,10000000))
# legend("topright", fill = c("black", "grey"), cex=1.8,
# legend = c("Unprotected", "Protected"))
# dev.off()
...
#s<-s[s$YearSold>=2010,]
#s$sqm<-s$sqfeet*0.09
s$Sales_sqm<-s$Sales_sqft/0.092903

m5<-tidy(lm(log(Sales_sqm)~cat,data=s))
m5.trim<-tidy(lm(log(Sales_sqm)~cat,data=s[(s$SalesPriceAmount>10000 & s$SalesPriceAmount<2800000),]))
m5.f<-tidy(lm(log(Sales_sqm)~cat+factor(FIPS),data=s))
m5.f.trim<-tidy(lm(log(Sales_sqm)~cat+factor(FIPS),data=s[(s$SalesPriceAmount>10000 & s$SalesPriceAmount<2800000),]))
m5.f.y<-tidy(lm(log(Sales_sqm)~cat+factor(FIPS)+YearSold,data=s))
m5.f.y.trim<-tidy(lm(log(Sales_sqm)~cat+factor(FIPS)+YearSold,data=s[(s$SalesPriceAmount>10000 & s$SalesPriceAmount<2800000),]))


png(paste0(Fig_dir,"SalePrice_sqft_res.png"),width=16,height=9,res=1200,units='in')
par(mar=c(5,6,4,1)+.1)
beanplot(Sales_sqft ~ Protection*CoBRA_Status, data=s, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Sale Price (2016 USD) - log scale ", cex.main=4,cex.lab=2,cex.axis=1.8,ylim=c(10,10000))
legend("topright", fill = c("black", "grey"), cex=1.8,
legend = c("Unprotected", "Protected"))
dev.off()

t<-pairwise.wilcox.test(s$Sales_sqft,s$cat,p.adjust.method="bonferroni")
write.csv(t$p.value,paste0(Tab_dir,"wilcox_Sales_sqft_res.csv"))
...
png(paste0(Fig_dir,"MarketValue_acre_vacant.png"),width=16,height=9,res=1200,units='in')
par(mar=c(5,6,4,1)+.1)
beanplot(LandValue_Acre ~ Protection*CoBRA_Status, data=v, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Market Values (USD/acre)-log scale", cex.main=4,cex.lab=2,cex.axis=1.8, ylim=c(1,10000000))
legend("bottomright", fill = c("black", "grey"), cex=1.8,
legend = c("Unprotected", "Protected"))
dev.off()

t<-pairwise.wilcox.test(v$LandValue_Acre,v$cat,p.adjust.method="bonferroni")
write.csv(t$p.value,paste0(Tab_dir,"wilcox_LVAcre_Vacant.csv"))



png(paste0(Fig_dir,"SalesPrice_acre_vacant.png"),width=16,height=9,res=1200,units='in')
par(mar=c(5,6,4,1)+.1)
beanplot(SalesPriceAcre ~ Protection*CoBRA_Status, data=v, ll = 0.04, side = "both", xlab="CoBRA Status", col = list("black", c("grey", "white")), what=c(1,1,1,0), ylab = "Sales Price (2016 USD/acre)-log scale", cex.main=4,cex.lab=2,cex.axis=1.8, ylim=c(10,1000000000))
legend("bottomright", fill = c("black", "grey"), cex=1.8,
legend = c("Unprotected", "Protected"))
dev.off()

t<-pairwise.wilcox.test(v$SalesPriceAcre,v$cat,p.adjust.method="bonferroni")
write.csv(t$p.value,paste0(Tab_dir,"wilcox_SalesPrivAcre_Vacant.csv"))

library(lfe)
# m1<-lm(PercentParcelBldg~cat,data=b)
# m1.f<-lm(PercentParcelBldg~cat+factor(FIPS),data=b)
# m2<-lm(PercentParcelBldg~cat,data=b[b$Area.bldg>0,])
# m2.f<-lm(PercentParcelBldg~cat+factor(FIPS),data=b[b$Area.bldg>0,])
# m3<-lm(log(sqm)~cat,data=r)
# m3.f<-lm(log(sqm)~cat+factor(FIPS),data=r)
# m4<-lm(FPR~cat,data=r)
# m4.f<-lm(FPR~cat+factor(FIPS),data=r)
# m5<-lm(log(Sales_sqm)~cat,data=s)
# m5.f<-lm(log(Sales_sqm)~cat+factor(FIPS),data=s)
